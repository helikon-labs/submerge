use crate::types::api::{
    dto::{
        ...
        response::{
            ...
            trace::{CursorTraceList, PaginatedTraceList, TraceDTO},
        },
    },
    error::APIErrorBody,
};
...
#[openapi(
    ...
    servers(
        ...
        (
            url = "https://kusama.crystal.api.submerge.io/v1",
            description = "API preview deployment for Kusama.",
        ),
        (
            url = "https://{kusama-parachain}.kusama.crystal.api.submerge.io/v1",
            description = "API preview deployment for Kusama parachains.",
            variables(
                ("kusama-parachain" = (
                    default = "asset-hub",
                    description = "Chain subdomain",
    ...
    components(
        ...
        responses(
            ...
            CursorTraceList, PaginatedTraceList,
