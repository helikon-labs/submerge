...
#[openapi(
    ...
    components(
        schemas(BlockDTO, CallDTO, EventDTO, GenesisRecordDTO, MetadataSummaryDTO, MetadataPalletSummaryDTO, MetadataPalletDTO, PaginationData, APIErrorBody, MetadataJSON),
        responses(
