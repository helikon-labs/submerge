CREATE TABLE IF NOT EXISTS metadata_pallet_error
(
    ...
    CONSTRAINT metadata_pallet_error_pk PRIMARY KEY(spec_version, pallet_index, index),
    CONSTRAINT metadata_pallet_error_fk_metadata_pallet
